...
// other widget — and NO PLUGIN MAY IMPORT ANOTHER PLUGIN. Shattering an Iconify
// icon or an SVG needs exactly the same three operations mermaid's shatter needed
// (measure a set of paths, and write them back out as an SVG source a widget can
// hold), so they moved here rather than being copied. mermaid imports them back.
