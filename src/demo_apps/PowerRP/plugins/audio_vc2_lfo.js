/**
 * VCV LFO — the `vcvLfo` engine module as a PowerRP node widget.
 *
 * MODULATION family: it drives other nodes rather than being heard.
 *
 * Four waveforms from one phase over eighteen octaves, clock-syncable.
 *
 ...
 * that data is VCV_LFO_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_LFO_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvLfoPlugin = audioNodePlugin(VCV_LFO_SPEC);
