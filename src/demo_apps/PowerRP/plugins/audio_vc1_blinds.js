/**
 * VCV BLINDS — the `vcvBlinds` engine module as a PowerRP node widget.
 *
 * MODULATION family (green header): it produces or shapes control.
 *
 * A quad four-quadrant VCA, which is to say a quad ring modulator.
 *
 ...
 * core/audio_nodes.js. What differs per module is DATA, and that data is VCV_BLINDS_SPEC in
...
import { VCV_BLINDS_SPEC } from "../core/audio_specs_vc1.js";

export const audioVcvBlindsPlugin = audioNodePlugin(VCV_BLINDS_SPEC);
