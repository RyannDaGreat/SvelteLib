/**
 * VCV FREQUENCY SHIFTER — the `vcvFreqShifter` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_FREQSHIFTER_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_FREQSHIFTER_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_FREQSHIFTER_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvFreqShifterPlugin = audioNodePlugin(VCV_FREQSHIFTER_SPEC);
