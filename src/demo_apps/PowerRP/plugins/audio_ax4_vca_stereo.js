/**
 * AX STEREO VCA — the `axVcaStereo` engine module as a PowerRP node widget.
 *
 * MODULATION family (muted blue header): it shapes or routes other nodes rather than being heard on its own.
 *
 * `sss/gain/vcaST`: one gain over two channels, ramped across each 16-sample control tick and deliberately one tick late.
 *
 ...
 * and that data is AX_VCA_STEREO_SPEC in core/audio_specs_ax4.js.
 *
...
import { AX_VCA_STEREO_SPEC } from "../core/audio_specs_ax4.js";

export const audioAxVcaStereoPlugin = audioNodePlugin(AX_VCA_STEREO_SPEC);
