/**
 * VCV Clkd — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_CLKD_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_CLKD_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvClkdPlugin = audioNodePlugin(VCV_CLKD_SPEC);
