/**
 * VCV VCA — the `vcvVca` engine module as a PowerRP node widget.
 *
 * MODULATION family: it drives a signal's level rather than being heard.
 *
 * A VCA with a choice of linear or two exponential laws.
 *
 ...
 * that data is VCV_VCA_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_VCA_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvVcaPlugin = audioNodePlugin(VCV_VCA_SPEC);
