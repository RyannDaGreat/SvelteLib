/**
 * SAMPLER — the `sampler` engine module as a PowerRP node widget.
 *
 * SOURCE family (warm amber header): it generates signal from nothing.
 *
 * Plays an audio buffer on a seamless loop. The user's 'audio files should also be able to be looped' — a bed of recorded sound under a synthesised patch.
 *
 ...
 * SAMPLER_SPEC in core/audio_specs.js — its ports, its knobs and their ranges,
...
import { SAMPLER_SPEC } from "../core/audio_specs.js";

export const audioSamplerPlugin = audioNodePlugin(SAMPLER_SPEC);
