/**
 * VCV Fade — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 * EFFECT family (violet header): it acts on a signal that already exists.
 *
 ...
 * that data is VCV_FADE_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_FADE_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvFadePlugin = audioNodePlugin(VCV_FADE_SPEC);
