/**
 * VCV CLOUDS — the `vcvClouds` engine module as a PowerRP node widget.
 *
 * EFFECT family (cool blue header): it transforms a signal that arrives.
 *
 * Mutable Instruments' granular processor. Nine of the twelve selected VCV decks are built on it.
 *
 ...
 * core/audio_nodes.js. What differs per module is DATA, and that data is VCV_CLOUDS_SPEC in
...
import { VCV_CLOUDS_SPEC } from "../core/audio_specs_vc1.js";

export const audioVcvCloudsPlugin = audioNodePlugin(VCV_CLOUDS_SPEC);
