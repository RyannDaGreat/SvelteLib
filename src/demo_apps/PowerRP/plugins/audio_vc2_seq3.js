/**
 * VCV SEQ3 — the `vcvSeq3` engine module as a PowerRP node widget.
 *
 * MODULATION family: it drives other nodes rather than being heard.
 *
 * Three eight-step CV rows and a gate row on one clock.
 *
 ...
 * that data is VCV_SEQ3_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_SEQ3_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvSeq3Plugin = audioNodePlugin(VCV_SEQ3_SPEC);
