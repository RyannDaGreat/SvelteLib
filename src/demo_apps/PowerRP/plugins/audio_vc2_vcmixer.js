/**
 * VCV VC MIXER — the `vcvVcMixer` engine module as a PowerRP node widget.
 *
 * MODULATION family: it drives levels rather than being heard.
 *
 * Four CV-controlled strips with per-channel outputs, square-law faders and a linear mix.
 *
 ...
 * that data is VCV_VCMIXER_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_VCMIXER_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvVcMixerPlugin = audioNodePlugin(VCV_VCMIXER_SPEC);
