/**
 * VCV ADSR — the `vcvAdsr` engine module as a PowerRP node widget.
 *
 * MODULATION family: it drives other nodes rather than being heard.
 *
 * Their envelope curve: one first-order approach per stage, aiming past 1 on the attack.
 *
 ...
 * that data is VCV_ADSR_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_ADSR_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvAdsrPlugin = audioNodePlugin(VCV_ADSR_SPEC);
