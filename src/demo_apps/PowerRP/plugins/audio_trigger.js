/**
 * TRIGGER — the `trigger` engine module as a PowerRP node widget.
 *
 * MODULATION family (muted blue header): it drives other modules rather than being heard.
 *
 * Rising-edge detector with Schmitt hysteresis. Turns any signal crossing a threshold into a clean pulse — the user's 'every time it goes from low to high triggers'.
 *
 ...
 * TRIGGER_SPEC in core/audio_specs.js — its ports, its knobs and their ranges,
...
import { TRIGGER_SPEC } from "../core/audio_specs.js";

export const audioTriggerPlugin = audioNodePlugin(TRIGGER_SPEC);
