/**
 * VCV SUPER — the `vcvSuper` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_SUPER_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_SUPER_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_SUPER_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvSuperPlugin = audioNodePlugin(VCV_SUPER_SPEC);
