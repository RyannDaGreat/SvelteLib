/**
 * VCV Clock Divider — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_CLOCK_DIVIDER_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_CLOCK_DIVIDER_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvClockDividerPlugin = audioNodePlugin(VCV_CLOCK_DIVIDER_SPEC);
