/**
 * VCV CAUDAL — the `vcvCaudal` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_CAUDAL_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_CAUDAL_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_CAUDAL_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvCaudalPlugin = audioNodePlugin(VCV_CAUDAL_SPEC);
