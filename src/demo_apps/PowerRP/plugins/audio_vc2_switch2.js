/**
 * VCV SEQUENTIAL SWITCH 2 — the `vcvSequentialSwitch2` engine module as a PowerRP node widget.
 *
 * EFFECT family (violet header): it routes a signal rather than filtering one.
 *
 * Four inputs, one output, walked by a clock.
 *
 ...
 * that data is VCV_SEQUENTIAL_SWITCH2_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_SEQUENTIAL_SWITCH2_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvSequentialSwitch2Plugin = audioNodePlugin(VCV_SEQUENTIAL_SWITCH2_SPEC);
