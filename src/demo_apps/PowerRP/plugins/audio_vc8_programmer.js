/**
 * VCV Programmer — the `vcvProgrammer` engine module as a PowerRP node widget.
 *
 * MODULATION family: it produces control, not sound.
 *
 * The CGS sixteen-step Serge programmer: four CV channels, per-stage run/stop/skip, and a select-trigger in plus a pulse out for every stage.
 *
 ...
 * that data is VCV_PROGRAMMER_SPEC in core/audio_specs_vc8.js.
 *
...
import { VCV_PROGRAMMER_SPEC } from "../core/audio_specs_vc8.js";

export const audioVcvProgrammerPlugin = audioNodePlugin(VCV_PROGRAMMER_SPEC);
