/**
 * VCV Event Timer — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_EVENT_TIMER_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_EVENT_TIMER_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvEventTimerPlugin = audioNodePlugin(VCV_EVENT_TIMER_SPEC);
