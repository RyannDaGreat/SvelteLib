/**
 * AX SOFT CLIP — the `axDistSoft` engine module as a PowerRP node widget.
 *
 * EFFECT family: audio in, audio out, and it changes the sound rather than making one.
 *
 * `dist/soft`: `y = 1.5x - 0.5x^3`, no state and no knobs. Their own description says no oversampling and no antialiasing, and that is audible.
 *
 ...
 * and that data is AX_DIST_SOFT_SPEC in core/audio_specs_ax4.js.
 *
...
import { AX_DIST_SOFT_SPEC } from "../core/audio_specs_ax4.js";

export const audioAxDistSoftPlugin = audioNodePlugin(AX_DIST_SOFT_SPEC);
