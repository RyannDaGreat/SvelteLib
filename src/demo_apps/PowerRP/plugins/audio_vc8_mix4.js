/**
 * NYSTHI Mix4 — the `vcvNysthiMix4` engine module as a PowerRP node widget.
 *
 * MODULATION family, as the harvested contract files it.
 *
 * A four-channel mixer whose volume CVs MULTIPLY, so a patched cable at 0 V mutes a channel while no cable leaves it alone.
 *
 ...
 * that data is VCV_NYSTHI_MIX4_SPEC in core/audio_specs_vc8.js.
 *
...
import { VCV_NYSTHI_MIX4_SPEC } from "../core/audio_specs_vc8.js";

export const audioVcvNysthiMix4Plugin = audioNodePlugin(VCV_NYSTHI_MIX4_SPEC);
