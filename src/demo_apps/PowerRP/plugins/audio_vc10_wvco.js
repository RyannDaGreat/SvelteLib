/**
 * VCV WVCO — the `vcvWvco` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_WVCO_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_WVCO_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_WVCO_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvWvcoPlugin = audioNodePlugin(VCV_WVCO_SPEC);
