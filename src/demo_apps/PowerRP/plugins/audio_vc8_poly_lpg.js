/**
 * Poly LPG — the `vcvPolyLpg` engine module as a PowerRP node widget.
 *
 * FILTER family (cool blue header): it shapes signal it is given.
 *
 * One Buchla low-pass gate, sharing the dual LPG's kernel because the changelog says it IS that section. Its polyphony is not ported (mono wires).
 *
 ...
 * that data is VCV_POLY_LPG_SPEC in core/audio_specs_vc8.js.
 *
...
import { VCV_POLY_LPG_SPEC } from "../core/audio_specs_vc8.js";

export const audioVcvPolyLpgPlugin = audioNodePlugin(VCV_POLY_LPG_SPEC);
