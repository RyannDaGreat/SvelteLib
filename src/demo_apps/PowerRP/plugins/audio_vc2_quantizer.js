/**
 * VCV QUANTIZER — the `vcvQuantizer` engine module as a PowerRP node widget.
 *
 * FILTER family (cool teal header): it shapes a signal that already exists.
 *
 * A 12-note scale mask over V/oct, exact-integer.
 *
 ...
 * that data is VCV_QUANTIZER_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_QUANTIZER_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvQuantizerPlugin = audioNodePlugin(VCV_QUANTIZER_SPEC);
