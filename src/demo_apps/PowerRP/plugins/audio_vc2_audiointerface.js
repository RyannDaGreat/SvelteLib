/**
 * VCV AUDIO — the `vcvAudioInterface` engine module as a PowerRP node widget.
 *
 * OUTPUT family: it is where a VCV patch's voltages leave.
 *
 * Rack's own /10: the boundary between this block's volts and our +-1 audio.
 *
 ...
 * that data is VCV_AUDIO_INTERFACE_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_AUDIO_INTERFACE_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvAudioInterfacePlugin = audioNodePlugin(VCV_AUDIO_INTERFACE_SPEC);
