/**
 * VCV DELAY — the `vcvDelay` engine module as a PowerRP node widget.
 *
 * EFFECT family (violet header): it acts on time rather than on spectrum.
 *
 * The echo whose time knob resamples its own history rather than jumping.
 *
 ...
 * that data is VCV_DELAY_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_DELAY_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvDelayPlugin = audioNodePlugin(VCV_DELAY_SPEC);
