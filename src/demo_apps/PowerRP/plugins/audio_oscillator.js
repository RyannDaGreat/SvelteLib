/**
 * OSCILLATOR — the `oscillator` engine module as a PowerRP node widget.
 *
 * SOURCE family (warm amber header): it generates signal from nothing.
 *
 * A single-voice tone generator — the primitive every subtractive patch starts from. Wire its output into a filter to shape it.
 *
 ...
 * OSCILLATOR_SPEC in core/audio_specs.js — its ports, its knobs and their ranges,
...
import { OSCILLATOR_SPEC } from "../core/audio_specs.js";

export const audioOscillatorPlugin = audioNodePlugin(OSCILLATOR_SPEC);
