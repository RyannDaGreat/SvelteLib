/**
 * VCV SQUONK — the `vcvSquonk` engine module as a PowerRP node widget.
 *
 * MODULATION family: it produces control, not sound.
 *
 * A Serge TKB-style twelve-stage programmer with five CV channels, per-stage jump/CV/trigger modes and per-stage ratcheting.
 *
 ...
 * that data is VCV_SQUONK_SPEC in core/audio_specs_vc8.js.
 *
...
import { VCV_SQUONK_SPEC } from "../core/audio_specs_vc8.js";

export const audioVcvSquonkPlugin = audioNodePlugin(VCV_SQUONK_SPEC);
