/**
 * VCV Boolean XOR — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_BOOLEAN_XOR_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_BOOLEAN_XOR_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvBooleanXorPlugin = audioNodePlugin(VCV_BOOLEAN_XOR_SPEC);
