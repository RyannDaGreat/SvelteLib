/**
 * INSTRUO SAICH — the `vcvSaich` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_SAICH_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_SAICH_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_SAICH_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvSaichPlugin = audioNodePlugin(VCV_SAICH_SPEC);
