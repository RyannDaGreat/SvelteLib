/**
 * VCV BLEAK — the `vcvBleak` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_BLEAK_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_BLEAK_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_BLEAK_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvBleakPlugin = audioNodePlugin(VCV_BLEAK_SPEC);
