/**
 * VCV RESCALE — the `vcvRescale` engine module as a PowerRP node widget.
 *
 * EFFECT family (violet header): it acts on a signal's range.
 *
 * Gain, offset and a folding limiter — and the volts-to-ours adapter this block needs.
 *
 ...
 * that data is VCV_RESCALE_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_RESCALE_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvRescalePlugin = audioNodePlugin(VCV_RESCALE_SPEC);
