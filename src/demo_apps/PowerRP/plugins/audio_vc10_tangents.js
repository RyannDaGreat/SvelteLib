/**
 * VCV TANGENTS — the `vcvTangents` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_TANGENTS_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_TANGENTS_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_TANGENTS_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvTangentsPlugin = audioNodePlugin(VCV_TANGENTS_SPEC);
