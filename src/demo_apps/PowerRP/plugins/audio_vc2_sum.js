/**
 * VCV SUM — the `vcvSum` engine module as a PowerRP node widget.
 *
 * MODULATION family: it combines control or audio signals.
 *
 * A sixteen-input summing bus — an unrolled poly cable's channels added up.
 *
 ...
 * that data is VCV_SUM_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_SUM_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvSumPlugin = audioNodePlugin(VCV_SUM_SPEC);
