/**
 * VCV F2 — the `vcvF2` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_F2_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_F2_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_F2_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvF2Plugin = audioNodePlugin(VCV_F2_SPEC);
