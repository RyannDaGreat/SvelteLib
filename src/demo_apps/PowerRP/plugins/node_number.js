 ...
 *  This node is a literal value — the simplest arithmetic source there is.
...
export const nodeNumberPlugin = {
  ...
  emit(s, _target, world) {
    const ops = [
      ...familyCard(s, "Number", NODE_FAMILY),
  ...
  localBounds: (state) => nodeInkBounds(nodeNumberPlugin, state),
