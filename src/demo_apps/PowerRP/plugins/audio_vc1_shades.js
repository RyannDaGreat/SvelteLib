/**
 * VCV SHADES — the `vcvShades` engine module as a PowerRP node widget.
 *
 * MODULATION family (green header): it produces or shapes control.
 *
 * A triple attenuverter and offset generator.
 *
 ...
 * core/audio_nodes.js. What differs per module is DATA, and that data is VCV_SHADES_SPEC in
...
import { VCV_SHADES_SPEC } from "../core/audio_specs_vc1.js";

export const audioVcvShadesPlugin = audioNodePlugin(VCV_SHADES_SPEC);
