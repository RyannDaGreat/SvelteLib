/**
 * VCV BASAL — the `vcvBasal` engine module as a PowerRP node widget.
 *
 ...
 * than modelled — is `VCV_BASAL_SPEC`'s `derivation` and its `help`.
 *
 ...
 * and that data is `VCV_BASAL_SPEC` in core/audio_specs_vc10.js.
 *
...
import { VCV_BASAL_SPEC } from "../core/audio_specs_vc10.js";

export const audioVcvBasalPlugin = audioNodePlugin(VCV_BASAL_SPEC);
