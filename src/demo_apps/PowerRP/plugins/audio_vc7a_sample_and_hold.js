/**
 * VCV Sample & Hold — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_SAMPLE_AND_HOLD_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_SAMPLE_AND_HOLD_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvSampleAndHoldPlugin = audioNodePlugin(VCV_SAMPLE_AND_HOLD_SPEC);
