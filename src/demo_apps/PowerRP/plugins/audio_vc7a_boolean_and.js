/**
 * VCV Boolean AND — the ported CountModula/ImpromptuModular module as a PowerRP node widget.
 *
 ...
 * that data is VCV_BOOLEAN_AND_SPEC in core/audio_specs_vc7a.js.
 *
...
import { VCV_BOOLEAN_AND_SPEC } from "../core/audio_specs_vc7a.js";

export const audioVcvBooleanAndPlugin = audioNodePlugin(VCV_BOOLEAN_AND_SPEC);
