/**
 * VCV LADDER FILTER — the `vcvVcf` engine module as a PowerRP node widget.
 *
 * FILTER family (cool teal header): it shapes a spectrum that already exists.
 *
 * The four-pole transistor ladder — the one node in this block whose nonlinearity IS the module.
 *
 ...
 * that data is VCV_VCF_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_VCF_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvVcfPlugin = audioNodePlugin(VCV_VCF_SPEC);
