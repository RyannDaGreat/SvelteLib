/**
 * REVERB — the `reverb` engine module as a PowerRP node widget.
 *
 * EFFECT family (violet header): it acts on time and space rather than on spectrum.
 *
 * Convolution reverb with GENERATED impulse responses. 'deepSpace' is the one the user's spacey-ambience brief is about.
 *
 ...
 * REVERB_SPEC in core/audio_specs.js — its ports, its knobs and their ranges,
...
import { REVERB_SPEC } from "../core/audio_specs.js";

export const audioReverbPlugin = audioNodePlugin(REVERB_SPEC);
