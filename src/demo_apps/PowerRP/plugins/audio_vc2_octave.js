/**
 * VCV OCTAVE — the `vcvOctave` engine module as a PowerRP node widget.
 *
 * MODULATION family: it transforms a control voltage.
 *
 * A V/oct octave transposer that rounds its knob and its CV separately.
 *
 ...
 * that data is VCV_OCTAVE_SPEC in core/audio_specs_vc2.js.
 *
...
import { VCV_OCTAVE_SPEC } from "../core/audio_specs_vc2.js";

export const audioVcvOctavePlugin = audioNodePlugin(VCV_OCTAVE_SPEC);
