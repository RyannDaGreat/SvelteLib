...
export const pdfPacketPlugin = {
  ...
  presets: [
    { name: "Casual read", description: "The defaults — a handled packet mid-read.", props: { flipAngle: 52, curl: 1, spreadTurned: 7, spreadRemaining: 1.2 } },
    { name: "Neat flip", description: "Tidy desk: tight fan, calm curl, square stack.", props: { flipAngle: 48, curl: 0.7, spreadTurned: 2.5, spreadRemaining: 0.4 } },
    { name: "Wild shuffle", description: "Well-thumbed: big fan, loose pages everywhere.", props: { flipAngle: 60, curl: 1.6, spreadTurned: 14, spreadRemaining: 3 } },
    { name: "Loopy peel", description: "The loopity-loop: an extravagant wide roll.", props: { flipAngle: 38, curl: 2.2, spreadTurned: 7, spreadRemaining: 1 } },
  ],
  commands: [
