...
// It was the simplest widget on the roster whose whole vocabulary — two ir.rect
// ops, the shared property registry, the effects bundle, standardBBoxAnchors —
// was ALREADY in the sandbox's provided API with nothing added. So it is the
// batch-1 baseline: if this file cannot register, the built-in plugin-asset path
// is broken, and the parity test in tests/builtin_plugin_assets_test.js says so
